      ...
      <div className="mx-auto flex items-center justify-between">
        <div className="flex">
          <button
            ...
            className={
              "text-gray-200 px-4 rounded focus:outline-none focus:border-white border-1 border-transparent hover:border-white transition-all hover:opacity-75 hover:cursor-pointer"
            }
          >
            Home
          </button>
